                       ...
                       <Topbar />
						...
						<div className="container ">
							...
							<div className="row w-100 mt-2 mb-0">
								 <div className="col">
									<div>
										<span className="page-heading"><i className="fa fa-user" aria-hidden="true"></i> Registered Users</span>
									...
									<div className='page-heading-bottom'> Home / Registered Users</div>
								 </div>
